...
def from_grpc_message(grpc_msg: mess_pb2.Message) -> GraphQLMessage:
    """Преобразует protobuf Message в GraphQL Message с поддержкой вложений, реакций, статусов."""
    ...
    statuses = [from_grpc_message_status(s) for s in grpc_msg.statuses]
    ...
    return GraphQLMessage(
        ...
        type="text",  # можно маппинг из grpc_msg.type
